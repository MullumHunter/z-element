...
`,"modal__error"),r=document.getElementById("modal-container"),m=document.getElementById("modal-blackbox"),i=document.getElementById("modal"),u=document.getElementById("lets-talk-btn"),F=f.querySelector("#modal-form"),_=()=>{i==null||i.classList.add("modal__visible"),document.body.classList.add("body__modal-opened")},n=()=>{i==null||i.classList.remove("modal__visible"),document.body.classList.remove("body__modal-opened")},c=()=>{n(),r.innerHTML=""},S=new h(r,f,_,n),E=new h(r,w,_,n),M=new h(r,L,_,n),g=new x(F);new C(F,g.send.bind(g),()=>{E.open()},()=>{M.open()});m==null||m.addEventListener("click",c);var b;(b=f.querySelector(".modal__close"))==null||b.addEventListener("click",c);var y;(y=w.querySelector(".modal__close"))==null||y.addEventListener("click",c);var v;(v=L.querySelector(".modal__close"))==null||v.addEventListener("click",c);u==null||u.addEventListener("click",S.open);
